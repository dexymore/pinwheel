const HeroFeaturedPostsCard = ({
    ...
    return (
      <div className="p-6  bg-white shadow-xl rounded-xl ml-2 mr-2">
        <div className="flex md:flex-row flex-col items-center">
          <img src={imageUrl} alt={title} className="md:mr-4 w-[100%] md:h-auto h-[20rem]" /> 
          <div className="flex flex-col text-start mt-6">
            <div>
              <a className=" border-2 border-[#ff6700] rounded-2xl px-6 py-1 text-[#ff6700] bg-[#b8a3952a] hover:text-white hover:bg-[#ff6700]" href="#">
                {category}
              </a>
            </div>
            <div className="">
  ...
  export default HeroFeaturedPostsCard;
